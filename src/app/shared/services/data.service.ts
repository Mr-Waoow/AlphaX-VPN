    ...
    return [
      {
        ...
        answers:
          "These are worldwide real residential proxies.",
      },
      {
        id: 2,
      ...
      },
      {
        ...
        answers:
          "You can't, the only supported method is IP.",
      },
      {
        id: 4,
        question:
      ...
      },
      {
        ...
        answers: "You can't. The amount of proxies of a particular city is always random. If it's important for you to have some specific city, you can take a look at our Mobile packages.",
      },
      {
        id: 6,
      ...
      },
      {
        ...
        answers: "Only some of them. If you need a package for mailing, you can take a look at Mail Special packages.",
      },
      {
        id: 8,
        question: "Can I change my package's pool?",
        answers: "You can do that if your package supports it. If it does, you'll see the \"Change pool\" button in your dashboard.",
      },
      {
        id: 9,
        question: 'Are residential proxies a stable solution?',
        answers: "They are quite stable. However, residential IPs can't last forever, and that's the main reason why they constantly rotate.",
      },
    ];
  }
    ...
    return [
      {
        ...
        name: 'DAILY UPDATE',
        icon: 'reason',
        description: 'Daily cleaning from spamhouse bases allows proxy packs to be not determined with services.',
      },
      {
        id: 2,
        name: 'UNLIMITED TRAFFIC',
        icon: 'reason',
        description: 'Unlimited traffic on any proxy packs for complete freedom of action in the network.',
      },
      {
        id: 3,
        name: 'SUPPORT ALL PROTOCOLS',
        icon: 'reason',
        description: 'We support the most popular protocols: SOCKS4 / 4a, SOCKS5, HTTP, HTTPS.',
      },
      {
        id: 4,
        name: 'FREE TEST',
        icon: 'reason',
        description: 'We provide all proxies to the test, so that you don’t make the wrong choice, and technical support will help you select proxy pack for specific tasks.',
      },
      {
        id: 5,
        name: '24/7 SUPPORT',
        icon: 'reason',
        description: 'Technical support always ready to prompt a proxy package for all your tasks.',
      },
    ];
  }
  constructor() {}
