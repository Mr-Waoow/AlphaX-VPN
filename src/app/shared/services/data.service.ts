...
import { ThemedProxy } from '../interfaces/themed-proxy';
...
export class DataService {
  ...
  getQuestionsData(): QuestionData[] {
    return [
      ...
      {
        question: 'How Many residentialThreads Can I Use?',
        answer:
          'We recommend 500 residentialThreads but you can use more than 500 (in this case we can’t guarantee hiqh quality).',
        id: 6,
        isLink: false,
        isButton: false,
        isTable: false,
  ...
  getFrequentlyAskes(): PersonalQuestion[] {
    return [
      ...
      },
      {
        ...
        answers: 'There is, you can only use up to 10 residentialThreads.',
      },
      {
        id: 9,
        question: 'Can I buy a proxy with unlimited thread count?',
        answers:
          'Yes, you can rent a private device with unlimited residentialThreads.',
      },
      {
        id: 10,
  ...
  getFrequentlyAskesResidential(): PersonalQuestion[] {
    return [
      {
        id: 1,
        question: 'What is the type of these proxies?',
        answers: 'These are worldwide real residential proxies.',
      },
      {
        id: 2,
        question: 'Are Residential proxies static?',
        answers:
          "They aren't. Residential packages are constantly rotating. Depending on a package, the rotation period can be from 5 minutes to several hours.",
      },
      {
        id: 3,
        question: 'Can I access the package by username and password?',
        answers: "You can't, the only supported method is IP.",
      },
      {
        id: 4,
        question: 'Can I choose the country?',
        answers:
          'We have some monogeographic packages, but if the country you need is not listed, you can still filter any mixed list with our Proxy Checker app. In this case you’ll have to buy the whole package.',
      },
      {
        id: 5,
        question: 'Can I choose a city?',
        answers:
          "You can't. The amount of proxies of a particular city is always random. If it's important for you to have some specific city, you can take a look at our Mobile packages.",
      },
      {
        id: 6,
        question: 'Can I choose ISP?',
        answers:
          "You can't. ISP is always random. In case you need some specific ISP, we recommend you to use our Exclusive or Mobile packages.",
      },
      {
        id: 7,
        question: 'Do Residential packages have SMTP and IMAP ports open?',
        answers:
          'Only some of them. If you need a package for mailing, you can take a look at Mail Special packages.',
      },
      {
        id: 8,
        question: "Can I change my package's pool?",
        answers:
          'You can do that if your package supports it. If it does, you\'ll see the "Change pool" button in your dashboard.',
      },
      {
        id: 9,
        question: 'Are residential proxies a stable solution?',
        answers:
          "They are quite stable. However, residential IPs can't last forever, and that's the main reason why they constantly rotate.",
      },
    ];
  }
    ...
    return [
      {
        ...
        geoOnlineIPs: [NaN],
        geoThreads: NaN,
        geoPriceResidential: [NaN],
        residentialOnlineIPs: [100],
        residentialThreads: 100,
        priceResidential: [5, 10, 30, 100],
        isDataCenter: false,
        dataCenterOnlineIPs: NaN,
        dataCenterThreads: NaN,
        priceDataCenter: [NaN],
        priceWithDiscount: 0,
        discount: 0,
      },
      {
        ...
        geoOnlineIPs: [20000],
        geoThreads: 300,
        geoPriceResidential: [NaN, 30, 150, 560],
        residentialOnlineIPs: [NaN],
        residentialThreads: NaN,
        priceResidential: [NaN],
        isDataCenter: false,
        dataCenterOnlineIPs: NaN,
        dataCenterThreads: NaN,
        priceDataCenter: [NaN],
      ...
      },
      {
        ...
        geoThreads: 300,
        geoPriceResidential: [NaN, 30, 150, 560],
        residentialOnlineIPs: [70, 60, 50],
        residentialThreads: 50,
        priceResidential: [5, 10, 30, 90],
        isDataCenter: false,
        dataCenterOnlineIPs: NaN,
        dataCenterThreads: NaN,
        priceDataCenter: [NaN],
      ...
      },
      {
        ...
        isResidential: true,
        isGeo: true,
        geoOnlineIPs: [4500, 3000, 2500],
        geoThreads: 300,
        geoPriceResidential: [NaN, 30, 150, 560],
        residentialOnlineIPs: [60, 50, 40],
        residentialThreads: 50,
        priceResidential: [5, 10, 30, 100],
        isDataCenter: true,
        dataCenterOnlineIPs: 12171,
        dataCenterThreads: 500,
        priceDataCenter: [90, 290, 990],
        priceWithDiscount: 0,
        discount: 0,
      },
      {
        ...
        geoThreads: NaN,
        geoPriceResidential: [NaN],
        residentialOnlineIPs: [50],
        residentialThreads: 50,
        priceResidential: [5, 10, 30, 90],
        isDataCenter: true,
        dataCenterOnlineIPs: 1009,
        dataCenterThreads: 500,
        priceDataCenter: [9, 29, 99],
        priceWithDiscount: 0,
        discount: 0,
      },
      {
      ...
      },
      {
        ...
        geoOnlineIPs: [20000],
        geoThreads: 300,
        geoPriceResidential: [NaN, 20, 80, 280],
        residentialOnlineIPs: [NaN],
        residentialThreads: NaN,
        priceResidential: [NaN],
        isDataCenter: true,
        dataCenterOnlineIPs: 1004,
        dataCenterThreads: 500,
        priceDataCenter: [9, 29, 99],
        priceWithDiscount: 0,
        discount: 0,
      ...
      },
      {
        ...
        residentialOnlineIPs: [NaN],
        residentialThreads: NaN,
        priceResidential: [NaN, NaN, NaN, NaN],
        isDataCenter: false,
        dataCenterOnlineIPs: NaN,
        dataCenterThreads: NaN,
        priceDataCenter: [NaN],
      ...
      },
      {
        ...
        operatorsIcon: ['kiyvstar.svg', 'vodafone.svg', 'life.svg', '3mob.png'],
        priceMobile: [3, 10, 40],
        isResidential: true,
        isGeo: false,
        geoOnlineIPs: [NaN],
    ...
    return [
      {
        ...
        isInfo: true,
        icon: 'mail',
        residentialOnlineIPs: [140000],
        residentialThreads: 300,
        priceResidential: [NaN, 40, 200, 720],
      },
      {
        id: 2,
        name: 'Aliexpress',
        isInfo: false,
        icon: 'aliexpress',
        residentialOnlineIPs: [20000],
        residentialThreads: 500,
        priceResidential: [NaN, 10, 30, 100],
      },
      {
        id: 3,
        name: 'Amazon',
  ...
  getUniversalProxyLists(): Feature[] {
    return [
      {
        id: 1,
        name: 'DAILY UPDATE',
        icon: 'reason',
        description:
          'Daily cleaning from spamhouse bases allows proxy packs to be not determined with services.',
      },
      {
        id: 2,
        name: 'UNLIMITED TRAFFIC',
        icon: 'reason',
        description:
          'Unlimited traffic on any proxy packs for complete freedom of action in the network.',
      },
      {
        id: 3,
        name: 'SUPPORT ALL PROTOCOLS',
        icon: 'reason',
        description:
          'We support the most popular protocols: SOCKS4 / 4a, SOCKS5, HTTP, HTTPS.',
      },
      {
        id: 4,
        name: 'FREE TEST',
      ...
      },
      {
        ...
        icon: 'reason',
        description:
          'Technical support always ready to prompt a proxy package for all your tasks.',
      },
    ];
  }
  constructor() {}
